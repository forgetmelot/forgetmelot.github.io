document.addEventListener('DOMContentLoaded', function () {
  ...
  var ORDER_SUBTEXTS = {
    Accipitriformes: 'hawks, eagles, kites, and friends',
    Anseriformes: 'waterfowl',
    Apodiformes: 'swifts and hummingbirds',
    Bucerotiformes: 'hornbills and hoopoes',
    Caprimulgiformes: 'nightjars and friends',
    Charadriiformes: 'shorebirds and friends',
    Ciconiiformes: 'storks',
    Columbiformes: 'pigeons and doves',
    Coraciiformes: 'rollers, kingfishers, and friends',
    Cuculiformes: 'cuckoos',
    Falconiformes: 'falcons and caracaras',
    Galliformes: 'landfowl',
    Gaviiformes: 'loons',
    Gruiformes: 'cranes, rails, and friends',
    Passeriformes: 'perching birds',
    Pelecaniformes: 'pelicans, herons, ibises, and friends',
  ...
  function buildBirdRibbonMarkup() {
    return [
      ...
      '    <ul class="nav-list">',
      '      <li><a href="' + getBirdPagePathPrefix() + 'me.html" class="nav-link"><span class="nav-part">about</span><span class="nav-part">me</span></a></li>',
      '      <li><a href="' + getBirdPagePathPrefix() + 'index.html" class="lucky nav-link"><span class="nav-part">surprise</span><span class="nav-part">bird!</span></a></li>',
      '    </ul>',
      '  </nav>',
      '</div>'
    ].join('\n');
